if (location.pathname === `/nation=${document.body.dataset.nname}`) {
  ...
  icon.alt = `${document.querySelector("#namebox td > p.nationname > a > span").textContent} was Commended by Security Council Resolution # 69`;
  icon.title = icon.alt;
  ...
  document
    .querySelector("#namebox td > p.nationname")
